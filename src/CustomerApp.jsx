            ...
            <>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  const msg = `🍔 *Burger Point Order*\n──────────────────\n${lines}\n──────────────────\n💰 *Total: ₹${total}*\n🛒 ${typeLabel}${nameLine}${phoneLine}${addrLine}${noteLine}`;
                  window.open(`https://wa.me/919194008822?text=${encodeURIComponent(msg)}`, "_blank");
                }}
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {SUPABASE_READY && supabaseDown && (
        <div className="bg-green-50 border-b border-green-200 px-4 py-2.5 flex items-center gap-2 max-w-2xl mx-auto w-full">
